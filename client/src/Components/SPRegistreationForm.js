...
const GymRegistreationForm = () => {
  ...
  const checkTimeSlot = async () => {
    ...
    const result = await axios.post("http://localhost:5000/checktimeavailablitypool", data);
    console.log(result);
  ...
  const adduser = async () => {
    ...
    console.log(data);
    const result = await axios.post("http://localhost:5000/addspooluser", data);
...
const allocatetime = async () => {
  ...
  await axios.post("http://localhost:5000/spoolallocatetime", data);
